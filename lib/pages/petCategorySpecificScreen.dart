...
class PetCategorySpecificSearchScreen extends StatefulWidget {
  ...
  @override
  _PetCategorySpecificSearchScreenState createState() => _PetCategorySpecificSearchScreenState();
}

class _PetCategorySpecificSearchScreenState extends State<PetCategorySpecificSearchScreen> {
          ...
          Navigator.push(
            ...
            MaterialPageRoute(
              builder: (BuildContext context) => PetDetailsScreen(
                name: this.name,
                imgUrl: this.url,
                category: this.category[0].toUpperCase() + this.category.substring(1),
